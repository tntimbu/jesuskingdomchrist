      ...
      {isJemaat && (
        <div className="space-y-6">
          ...
          <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-slate-900/80 backdrop-blur-xl border border-indigo-500/30 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0 w-full md:w-auto shrink-0 no-scrollbar">
              <button
                onClick={() => onNavigate('renungan')}
                className="flex-1 sm:flex-initial px-3 py-2 rounded-xl bg-indigo-600/90 hover:bg-indigo-600 text-white font-bold text-[11px] sm:text-xs border border-indigo-400/30 shadow-md shadow-indigo-600/20 transition-all cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap shrink-0"
              >
              ...
              <button
                ...
                className="flex-1 sm:flex-initial px-3 py-2 rounded-xl bg-emerald-600/90 hover:bg-emerald-600 text-white font-bold text-[11px] sm:text-xs border border-emerald-400/30 shadow-md shadow-emerald-600/20 transition-all cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap shrink-0"
              >
              ...
              <button
                ...
                className="flex-1 sm:flex-initial px-3 py-2 rounded-xl bg-red-600/90 hover:bg-red-600 text-white font-bold text-[11px] sm:text-xs border border-red-400/30 shadow-md shadow-red-600/20 transition-all cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap shrink-0"
              >
                ...
                <div className="pt-3 border-t border-white/10 flex items-center justify-between text-xs">
                  ...
                  {latestRenungan ? (
                    ...
                    >
                      ...
                      <span>Baca Layar Penuh &rarr;</span>
                    </button>
                  ) : (
                    <button
                      onClick={() => onNavigate('renungan')}
