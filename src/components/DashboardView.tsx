          ...
          <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-slate-900/80 backdrop-blur-xl border border-indigo-500/30 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="grid grid-cols-3 gap-2 w-full md:w-auto shrink-0">
              <button
                ...
                className="px-2.5 sm:px-3.5 py-2 rounded-xl bg-indigo-600/90 hover:bg-indigo-600 text-white font-bold text-[11px] sm:text-xs border border-indigo-400/30 shadow-md shadow-indigo-600/20 transition-all cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap"
              >
              ...
              <button
                ...
                className="px-2.5 sm:px-3.5 py-2 rounded-xl bg-emerald-600/90 hover:bg-emerald-600 text-white font-bold text-[11px] sm:text-xs border border-emerald-400/30 shadow-md shadow-emerald-600/20 transition-all cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap"
              >
              ...
              <button
                ...
                className="px-2.5 sm:px-3.5 py-2 rounded-xl bg-red-600/90 hover:bg-red-600 text-white font-bold text-[11px] sm:text-xs border border-red-400/30 shadow-md shadow-red-600/20 transition-all cursor-pointer flex items-center justify-center gap-1.5 whitespace-nowrap"
              >
